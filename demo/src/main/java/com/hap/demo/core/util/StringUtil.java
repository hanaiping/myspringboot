...
public class StringUtil {
    ...
    private final static String isOnceSQLField = "^[A-Za-z0-9*_]+$";
    ...
    private final static String reg_isEnglishOrNumeric = "^[A-Za-z0-9]+$";
    //Email地址
    private static final String EMAIL_ADDRESS = "^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$";
    ...
    public final static boolean isEmail(String str) {
        return match(str, EMAIL_ADDRESS);
    }
     ...
     * @author chengjun
     */
    public final static boolean isOnceSQLField(final String text) {
    ...
    public static String handleTitle(String str) {
        // str = " 和骨干<topic name='我们的以后'>#我们的以后</topic>风将衡桂接";
     ...
     * 判断话题和@好友的格式是否正确
     */
    public static String flagTopicAndUser(String str) {
        boolean flag1 = str.contains("<user i<topic");
        boolean flag2 = str.contains("<use<topic");
        boolean flag3 = str.contains("<topic<user");
        if (flag1 || flag2 || flag3) {
            //格式存在错误
            int i = str.indexOf("<topic name");
            int j = str.indexOf("c>");
            String ss = str.substring(i, j + 2);
            return ss;
        } else {
            //格式没有问题
            return str;
...
//        }
        ...
        ///sadasd/asdasd/,/loging/asd1asd/,/tbUserLog,/actuator/health,/actuator/env,/actuator/metrics/**,/actuator/trace,/actuator/dump,/actuator/jolokia,/actuator/info,/actuator/logfile,/actuator/refresh,/actuator/flyway,/actuator/liquibase,/actuator/heapdump,/actuator/loggers,/actuator/auditevents,/actuator/env/PID,/actuator/jolokia/**,/v2/api-docs/**,/swagger-ui.html,/swagger-resources/**,/webjars/**,/tbUserAttention/getUserAttentionStatus,/api/userCenter/getFansCount,/api/userCenter/getUserInfoList,/v1/api/live/freeze/agora,/tbSms/sms/codes,/v1/api/live/freeze/tencent,/v1/api/live/freeze/GetModel

        String filePattm="/sadasd/asdasd/,/loging/asd1asd/,/tbUserLog,/actuator/**,/actuator/health,/actuator/env,/actuator/metrics/**,/actuator/trace,/actuator/dump,/actuator/jolokia,/actuator/info,/actuator/logfile,/actuator/refresh,/actuator/flyway,/actuator/liquibase,/actuator/heapdump,/actuator/loggers,/actuator/auditevents,/actuator/env/PID,/actuator/jolokia/**,/v2/api-docs/**,/swagger-ui.html,/swagger-resources/**,/webjars/**,/tbUserAttention/getUserAttentionStatus,/api/userCenter/getFansCount,/api/userCenter/getUserInfoList,/v1/api/live/freeze/agora,/tbSms/sms/codes,/v1/api/live/freeze/tencent,/v1/api/live/freeze/GetModel";

        String uris="/actuator/health";

        //  /actuator/**   /actuator/env:false
        url=Arrays.asList(filePattm.split(","));
        for(String str:url){
